...
(async () => {
    const DIR = {
        email: '39183@kristin.school.nz',  // replace YOUR EMAIL with your email for auto login (keep everything else the same)
        password: 'Bonny775',  // replace YOUR PASSWORD with your password for auto login
